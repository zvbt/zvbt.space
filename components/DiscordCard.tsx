        ...
        <div
            className="w-90 sm:w-96 z-10 rounded-tr-lg p-2 sm:p-5 rounded-lg">
                <div className="flex flex-col">
                    ...
                    <div className={cn("",status === "dnd" && "fixed w-4 h-4 rounded-full ml-[50px] mt-[48px] bg-[#e78284] border-2 border-black",status === "online" && "fixed w-4 h-4 rounded-full ml-[50px] mt-[48px] bg-[#a6d189] border-2 border-black",status === "idle" && "fixed w-4 h-4 rounded-full ml-[50px] mt-[48px] bg-[#e5c890] border-2 border-black",status === "offline" && "fixed w-4 h-4 rounded-full ml-[50px] mt-[48px] bg-[#737994] border-2 border-black")}></div>
